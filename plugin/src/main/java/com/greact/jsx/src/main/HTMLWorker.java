...
public class HTMLWorker extends HTMLParserBaseListener {
    private void recurse(Iterator iterator) {
        while (iterator.hasNext()) {
            ...
            try {
                iterator2 = ((HTMLParser.HtmlElementsContext) elem).children.iterator();
                recurse(iterator2);
            } catch (Exception ignored) {
            }
            ...
            if (iterator2 == null)
                try {
                    iterator2 = ((HTMLParser.HtmlElementContext) elem).children.iterator();
                    recurse(iterator2);
                } catch (Exception ignored) {
                }
        }
